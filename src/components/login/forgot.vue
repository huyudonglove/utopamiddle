<template>
    <div class="h-div">
      <div class="h-login">
        <div class="h-head">utopa AR</div>
        <div style="margin-top: 10px">
          <span style="display: inline-block;width: 100px;text-align: center;">账号</span>
          <el-input v-model="email" style="width: 180px"></el-input> <el-button @click="sendCode" :disabled="disabled">发送验证码 <span v-if="disabled">{{time+'s'}}</span></el-button>
        </div>
        <div style="margin-top: 10px">
          <span style="display: inline-block;width: 100px;text-align: center;">验证码</span>
          <el-input v-model="code" style="width: 250px"></el-input>
        </div>
        <div style="margin-top: 10px">
          <span style="display: inline-block;width: 100px;text-align: center;">新密码</span>
          <el-input v-model="newPass" style="width: 250px" type="password"></el-input>
        </div>
        <div style="margin-top: 10px">
          <span style="display: inline-block;width: 100px;text-align: center;">确认密码</span>
          <el-input v-model="checkPass" style="width: 250px" type="password"></el-input>
        </div>
